% DOCUMENT CLASS %
\documentclass[a4paper, twoside, 12pt]{article}   % for A4 Paper, 12pt fontsize.
...
% Maybe add as an actual new command, but tbh I think nobody uses this symbol...
\renewcommand*{\O}{\mathcal O}    % Landau set of a function
